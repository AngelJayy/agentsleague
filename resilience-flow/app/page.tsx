...
export default function ResilienceFlow() {
  ...
  return (
    <div className="min-h-screen bg-[#020817] text-white p-8 font-mono">
      <h1 className="text-2xl font-black italic mb-8 border-b border-slate-800 pb-4 uppercase">
      ...
      <textarea 
        ...
        placeholder="Ingest crisis data..."
        value={userInput}
        onChange={(e) => setUserInput(e.target.value)}
      />
      <button onClick={runSimulation} className="w-full bg-blue-600 py-4 rounded-xl font-bold uppercase mb-10">
